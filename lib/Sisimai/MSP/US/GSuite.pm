...
Sisimai::MSP::US::GSuite - bounce mail parser class for C<G Suite>.

=head1 SYNOPSIS

    use Sisimai::MSP::US::GSuite;

=head1 DESCRIPTION

Sisimai::MSP::US::GSuite parses a bounce email which created by C<G Suite>.
...
C<description()> returns description string of this module.
    ...
    print Sisimai::MSP::US::GSuite->description;

=head2 C<B<smtpagent()>>

C<smtpagent()> returns MTA name.

    print Sisimai::MSP::US::GSuite->smtpagent;
