...
sub get {
    ...
    state $messagesof = {
        'authfailure' => [
            ...
            #   Define your SPF recordâ€”Basic setup. https://support.google.com/a/answer/10685031
        ...
        'requireptr' => [
            ...
            # - 421 4.7.23 The sending IP address for this message doesnft have a PTR record, or
            #   the PTR record's forward DNS entry doesnft match the sending IP address. To protect
