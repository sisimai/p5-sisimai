...
sub get {
    ...
    state $messagesof = {
        'authfailure' => [
            ...
            #   sage has been blocked. Please visit [Prevent mail to Gmail users from being blocked
            #   or sent to spam] for more information.
            ...
            #   been blocked. Please visit [Prevent mail to Gmail users from being blocked or sent
            #   to spam] for more information.
            [550, '5.7.26', 'this message fails to pass spf checks for an spf record with a hard fail'],
        ],
        'badreputation' => [
        ...
        'blocked' => [
            ...
            #   dress has been temporarily blocked. For more information, visit [Prevent mail to
            #   Gmail users from being blocked or sent to spam].
            ...
            #   from your IP address. To protect our users from spam, mail sent from your IP ad-
            #   dress has been blocked. Review [Prevent mail to Gmail users from being blocked or
            #   sent to spam].
            ...
            #   more information, visit [The IP you're using to send email is not authorized...].
        ...
        'exceedlimit' => [
            ...
            #   visit [Send attachments with your Gmail message].
        ...
        'policyviolation' => [
            ...
            #   further details. For more information, visit [Sorry, a policy is in place that pre-
            #   vents your message from being sent].
            ...
            #   ty issue. Please visit [https://support.google.com/mail/?p=BlockedMessage] to re-
            #   view our message content and attachment content guidelines.
        ...
        'securityerror' => [
            ...
            # - 530 5.5.1 Authentication Required. For more information, visit [Can't sign in to
            #   your Google Account].
            ...
            #   mation, visit [Check Gmail through other email platforms].
            [535, '5.7.1', 'please log in with your web browser and then try again'],

            # - 535 5.7.1 Username and Password not accepted. For more information, visit [Can't
        ...
        'spamdetected' => [
            ...
            #   information, visit [Why has Gmail blocked my messages]?
        ...
        'speeding' => [
            ...
            #   time, your message will be delivered. For more information, visit [Limits for send-
            #   ing & getting mail].
            ...
            #   delivered. For more information, visit [Limits for sending & getting mail].
        ...
        'toomanyconn' => [
            ...
            #   Google's sending limits, visit [Limits for sending & getting mail].
        ...
        'userunknown' => [
            ...
            #   For more information, visit [Fix bounced or rejected emails].
    ...
    my $esmtpreply = int substr($argvs->{'replycode'}, 1, 2);   # 5.7.1 => 7.1
