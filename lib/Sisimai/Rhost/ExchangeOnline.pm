...
sub get {
    ...
    state $messagesof = {
        ...
        'blocked' => [
            ...
            # - If this activity is valid, this restriction will be lifted shortly.
            ['4.7.', 500, 599, 'access denied, please try again later'],
            ['4.7.', 600, 699, 'access denied, please try again later'],
        ...
        'userunknown' => [
            ...
            ['5.1.4', 0, 0, 'recipient address reserved by rfc 2606'],
            ['5.1.5', 0, 0, 'recipient address reserved by rfc 2606'],
    ...
    my $statuscode = $argvs->{'deliverystatus'} || 0;
