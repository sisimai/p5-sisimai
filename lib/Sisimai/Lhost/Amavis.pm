...
Sisimai::Lhost::Amavis - bounce mail decoder class for C<amavisd-new>.
...
C<Sisimai::Lhost::Amavis> decodes a bounce email which created by C<amavisd-new>. Methods in the
module are called from only C<Sisimai::Message>.
