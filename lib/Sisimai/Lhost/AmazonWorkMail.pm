...
Sisimai::Lhost::AmazonWorkMail - bounce mail decoder class for Amazon WorkMail L<https://aws.amazon.com/workmail/>.
...
C<Sisimai::Lhost::AmazonWorkMail> decodes a bounce email which created by Amazon WorkMail L<https://aws.amazon.com/workmail/>.
