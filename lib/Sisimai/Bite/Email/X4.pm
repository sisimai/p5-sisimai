...
my $ReCommands = qr/Sorry,[ ]no[ ]SMTP[ ]connection[ ]got[ ]far[ ]enough;[ ]most[ ]progress[ ]was[ ]([A-Z]{4})[ ]/x;
my $ReFailures = {
...
Sisimai::Bite::Email::X4 - bounce mail parser class for Unknown MTA which is
developed as a C<qmail> clone.

=head1 SYNOPSIS

    use Sisimai::Bite::Email::X4;

=head1 DESCRIPTION

Sisimai::Bite::Email::X4 parses a bounce email which created by some C<qmail>
...
C<description()> returns description string of this module.
    ...
    print Sisimai::Bite::Email::X4->description;

=head2 C<B<smtpagent()>>

C<smtpagent()> returns MTA name.

    print Sisimai::Bite::Email::X4->smtpagent;
