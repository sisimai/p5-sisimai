...
Sisimai::Bite::Email::X2 - bounce mail parser class for C<X2>.

=head1 SYNOPSIS

    use Sisimai::Bite::Email::X2;

=head1 DESCRIPTION

Sisimai::Bite::Email::X2 parses a bounce email which created by Unknown MTA #2.
...
C<description()> returns description string of this module.
    ...
    print Sisimai::Bite::Email::X2->description;

=head2 C<B<smtpagent()>>

C<smtpagent()> returns MTA name.

    print Sisimai::Bite::Email::X2->smtpagent;
