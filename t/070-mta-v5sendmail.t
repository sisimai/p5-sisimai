...
my $PackageName = 'Sisimai::MTA::V5sendmail';
my $MethodNames = {
    'class' => [ 
...
my $ReturnValue = {
    ...
    '05' => { 'status' => qr/\A5[.]0[.]\d+\z/, 'reason' => qr/(?:hostunknown|blocked|filtered)/ },
};
...
MAKE_TEST: {
    ...
    PARSE_EACH_MAIL: for my $n ( 1..20 ) {
        ...
        my $emailfn = sprintf( "./eg/maildir-as-a-sample/new/v5sendmail-%02d.eml", $n );
        ...
        while( my $r = $mailbox->read ) {
            ...
            for my $e ( @{ $p->ds } ) {
                ...
                is $e->{'agent'}, 'V5sendmail', '->agent = '.$e->{'agent'};
