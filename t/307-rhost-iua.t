...
my $PackageName = 'Sisimai::Rhost::IUA';
my $MethodNames = {
    'class' => ['get'],
    'object' => [],
};
...
MAKE_TEST: {
    my $rs = {
        '01' => { 'status' => qr/\A5[.]0[.]0\z/, 'reason' => qr/suspend/ },
    };
    ...
    PARSE_EACH_MAIL: for my $n ( keys %$rs ) {
        my $emailfn = sprintf("./set-of-emails/maildir/bsd/rhost-iua-%02d.eml", $n);
        my $mailbox = Sisimai::Mail->new($emailfn);
        my $mtahost = qr/mx[0-9]+[.]email[.]ua/;
