...
my $PackageName = 'Sisimai::Rhost::NTTDOCOMO';
my $MethodNames = {
    'class' => ['get'],
    'object' => [],
};
...
MAKE_TEST: {
    my $rs = {
        '01' => { 'status' => qr/\A5[.]2[.]0\z/, 'reason' => qr/filtered/ },
        '02' => { 'status' => qr/\A5[.]0[.]0\z/, 'reason' => qr/userunknown/ },
        '03' => { 'status' => qr/\A5[.]0[.]0\z/, 'reason' => qr/userunknown/ },
    };
    ...
    PARSE_EACH_MAIL: for my $n ( keys %$rs ) {
        my $emailfn = sprintf("./set-of-emails/maildir/bsd/rhost-nttdocomo-%02d.eml", $n);
        my $mailbox = Sisimai::Mail->new($emailfn);
        my $mtahost = qr/mfsmax[.]docomo[.]ne[.]jp\z/;
