...
my $SampleJSONs = [
    'json-amazonses/json-amazonses-01.json',
#   'json-amazonses/json-amazonses-02.json',
    'json-amazonses/json-amazonses-03.json',
#   'json-amazonses/json-amazonses-04.json',
#   'json-amazonses/json-amazonses-05.json',
    'json-amazonses/json-amazonses-06.json',
    'json-sendgrid/json-sendgrid-01.json',
    'json-sendgrid/json-sendgrid-02.json',
    'json-sendgrid/json-sendgrid-03.json',
    'json-sendgrid/json-sendgrid-04.json',
    'json-sendgrid/json-sendgrid-05.json',
    'json-sendgrid/json-sendgrid-06.json',
    'json-sendgrid/json-sendgrid-07.json',
    'json-sendgrid/json-sendgrid-08.json',
    'json-sendgrid/json-sendgrid-09.json',
    'json-sendgrid/json-sendgrid-10.json',
    'json-sendgrid/json-sendgrid-11.json',
    'json-sendgrid/json-sendgrid-12.json',
#   'json-sendgrid/json-sendgrid-13.json',
    'json-sendgrid/json-sendgrid-14.json',
    'json-sendgrid/json-sendgrid-15.json',
    'json-sendgrid/json-sendgrid-16.json',
    'json-sendgrid/json-sendgrid-17.json',
];
